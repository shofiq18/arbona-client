...
// import { useAddCategoryMutation, useGetCategoriesQuery } from '@/redux/api/auth/categories/categoriesApi';
...
//  const [addCategory, { data: addCategoryData, isLoading: isCreating }] = useAddCategoryMutation();

//   console.log(addCategoryData, "add category data");
...
//                 <td className="p-2">{category.description}</td>
//                 <td className="p-2 flex space-x-2">
//                   {/* View, Update, Delete dialogs omitted for brevity — reuse your previous ones here */}
//                   <Button size="sm" onClick={() => handleView(category)}>View</Button>
//                   <Button size="sm" onClick={() => handleUpdate(category)}>Edit</Button>
