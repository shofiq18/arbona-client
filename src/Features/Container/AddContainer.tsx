...
const AddContainerPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!container.containerNumber || !container.containerName || !container.deliveryDate || !container.shippingCost || container.containerProducts.length === 0) {
      alert('Please fill all container details and add at least one product.');
      return;
    }
  ...
  return (
    // <div className="p-6">
    //   <div className=''>
    //     <h1 className="text-2xl font-bold  my-4">Add Container</h1>
    //   </div>
    ...
    //           </div>
    //           <div>
    //             <button type="submit" className="bg-red-500 text-white p-2 py-2 px-6  rounded mt-6" disabled={isLoading}>
    //               Submit
    //             </button>
    //           </div>
    ...
    //         </div>
    //         <div>
    //           <label className=" text-sm font-medium mb-1">Item Number</label>
    //           <select
    //             name="itemNumber"
    ...
    //         <div>
    //           <label className=" text-sm font-medium mb-1">Sales Price</label>
    //           <input
    //             type="number"
    //             name="salesPrice"
    ...
    //       </div>
    //       <div>
    //         <label className=" text-sm font-medium mb-1">Per Case Cost</label>
    //         <input
    //           type="number"
    //           name="perCaseCost"
