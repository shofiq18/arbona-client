    ...
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex gap-2">
          ...
          <Button
            variant="outline"
            className="text-gray-500 cursor-pointer border border-gray-300 hover:bg-gray-500"
          >
          ...
          <tbody>
            {filteredData.map((row) => (
              <tr key={row._id} className="border-t hover:bg-gray-50">
                ...
                <td className="p-2 whitespace-nowrap">{row.storePersonName}</td>
                ...
                <td className="p-2 whitespace-nowrap flex gap-2">
                  <Eye
                    ...
                    onClick={() => router.push(`/dashboard/customer/${row._id}`)}
                  />
                  <Edit
      ...
      <div className="flex justify-between items-center text-sm text-gray-600 mt-4">
        <p>Showing 1 to {filteredData.length} of {customers.length}</p>
        <div className="flex items-center gap-1">
